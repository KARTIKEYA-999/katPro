...
const TRANSLATIONS = {
    en: {
        ...
        create_farmer_link: "Create New Farmer Account",
        back_to_login: "Back to Sign In",
        new_farmer_prompt: "New to the platform?",
        already_account_prompt: "Already have an account?",
        fill_sample_label: "Fill Sample:",
    ...
    hi: {
        ...
        create_farmer_link: "नया किसान खाता बनाएं",
        back_to_login: "साइन इन पर वापस जाएं",
        new_farmer_prompt: "क्या आप नए किसान हैं?",
        already_account_prompt: "क्या आपके पास पहले से खाता है?",
        fill_sample_label: "नमूना भरें:",
    ...
    te: {
        ...
        create_farmer_link: "కొత్త రైతు ఖాతాను సృష్టించండి",
        back_to_login: "తిరిగి లాగిన్ పేజీకి వెళ్లండి",
        new_farmer_prompt: "మీరు కొత్త రైతులా?",
        already_account_prompt: "ఇప్పటికే ఖాతా ఉందా?",
        fill_sample_label: "నమూనా ఆధారాలు:",
